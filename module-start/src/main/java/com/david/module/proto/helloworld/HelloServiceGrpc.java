...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.david.module.proto.helloworld.HelloRequest,
      com.david.module.proto.helloworld.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.david.module.proto.helloworld.HelloRequest.class,
      responseType = com.david.module.proto.helloworld.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.david.module.proto.helloworld.HelloRequest,
      com.david.module.proto.helloworld.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.david.module.proto.helloworld.HelloRequest, com.david.module.proto.helloworld.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.david.module.proto.helloworld.HelloRequest, com.david.module.proto.helloworld.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.david.module.proto.helloworld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.david.module.proto.helloworld.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.david.module.proto.helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.david.module.proto.helloworld.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.david.module.proto.helloworld.HelloRequest,
                com.david.module.proto.helloworld.HelloReply>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.david.module.proto.helloworld.HelloReply sayHello(com.david.module.proto.helloworld.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.david.module.proto.helloworld.HelloReply> sayHello(
        com.david.module.proto.helloworld.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.david.module.proto.helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.david.module.proto.helloworld.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.david.module.proto.helloworld.HelloWorldProto.getDescriptor();
    }
