//
//package com.david.module.data.mysql.datasource;
////
...
//        // 设置xml的路径
//    //    bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com.david.module.data.mysql.mapper/*.xml"));
